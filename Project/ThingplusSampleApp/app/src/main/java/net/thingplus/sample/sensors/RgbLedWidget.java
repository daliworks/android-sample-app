...
public class RgbLedWidget extends ActuatorWidget {
    public static final String WIDGET_TYPE = "rgbled";
    private static final String CMD = "Last Command: ";
    private static final String KEY_CMD = "cmd";

    public RgbLedWidget(String name, Object value, long updatedTime) {
