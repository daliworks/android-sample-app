...
public class SensorWidget implements Sensors {
    public static final String WIDGET_TYPE = "sensor";
    ...
    public SensorWidget(String name, Object value, long updatedTime) {
        mName = name;
        mValue = value;
    ...
    public int getSensorIcon() {
        return R.drawable.icon_defaultsensor;
    }
