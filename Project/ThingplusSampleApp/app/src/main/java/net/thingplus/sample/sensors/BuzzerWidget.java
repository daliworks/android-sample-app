...
public class BuzzerWidget extends ActuatorWidget {
    public static final String WIDGET_TYPE = "buzzer";
    private static final String CMD = "Last Command: ";
    private static final String KEY_CMD = "cmd";

    public BuzzerWidget(String name, Object value, long updatedTime) {
