...
public class LcdWidget extends ActuatorWidget {
    public static final String WIDGET_TYPE = "lcd";
    private static final String CMD = "Last Command: ";
    private static final String KEY_CMD = "cmd";

    public LcdWidget(String name, Object value, long updatedTime) {
